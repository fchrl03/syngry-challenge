  ...
  render() {
    ...
    return `
          <div class="col=lg-4 col-md-4 col-sm-12 mx-2">
              <div class="card mx-0 my-4 g-0 shadow" style="width: 18rem;">
                  ...
                  <div class="card-body" style="font-size: 14px">
                      ...
                      <div class="my-2"><i class='bx bxs-user me-2'></i>${this.capacity} Orang</div>
                      <div class="my-2"><i class='bx bxs-cog me-2'></i>${this.transmission}</div>
                      <div class="my-2"><i class='bx bxs-calendar me-2'></i>${this.year}</div>
